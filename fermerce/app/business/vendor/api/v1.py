...
from fermerce.app.business.vendor import schemas
from fermerce.app.business.vendor.models import Vendor
from fermerce.app.business.vendor.services import business
from fermerce.app.users.staff.dependency import require_super_admin
...
async def login(
    ...
    result = await business.login_vendor(data_in=data_in, request=request, task=task)
    return result
