...
async def create_details(data_in: schemas.IProductDetailsIn, vendor: Vendor):
    ...
    if not get_product:
        raise exceptions.NotFoundError("product detail not found")
    to_create = [
    ...
    raise exceptions.ServerError("error creating product details")
...
async def update_product_detail(
    ...
    if not get_product_detail:
        raise exceptions.NotFoundError("product detail does not exist")
...
async def delete_product_detail(
    ...
    raise exceptions.NotFoundError("product or product details is not found")
