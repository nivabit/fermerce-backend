...
async def create_warehouse(data_in: schemas.IWarehouseIn):
    ...
    if check_warehouse:
        raise exceptions.DuplicateError("warehouse already exists")
    ...
    raise exceptions.ServerError("error creating warehouse")
...
async def update_warehouse(
    ...
    if not get_warehouse:
        raise exceptions.NotFoundError("warehouse not found")
    ...
    if check_if_exist:
        ...
        return result
    raise exceptions.ServerError("Could not update warehouse ")
