...
from fermerce.app.promo_code import schemas, services
...
async def add_product_to_promo_code(
    ...
    return await services.add_product_to_promo_code(
        data_in=data_in, vendor=vendor
    )
...
async def remove_product_from_promo_code(
    ...
    return await services.delete_product_from_promo_code(
        data_in=data_in, vendor=vendor
    )
