...
from fermerce.app.permission import schemas, models
...
async def create(
    ...
    if check_permission:
        raise exceptions.DuplicateError("permission already exists")
...
async def get(
    ...
    if not perm:
        raise exceptions.NotFoundError("permission not found")
    return perm
...
async def update(
    ...
    if not check_permission:
        raise exceptions.NotFoundError("permission does not exist")
